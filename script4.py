...
def predict():
    ...
    try:
        ...
        plt.plot(time_labels, forecast_floats, marker='o', label="Forecasted €/kWh")
        plt.title("LSTM Forecasted Electricity Prices (Next 24 Hours)")
        plt.xlabel("Time")
        plt.ylabel("€/kWh")
        plt.grid(True)
        ...
        plot_path = "static/lstm_forecast.png"
